...
if(!$args) { "sudo - execute a command as admin`n`nusage: sudo [<command>]"; exit 1 }
...
if(!(is_admin)) {
	[console]::error.writeline("%username% is not in the sudoers file.  This incident will be reported.")
	exit 1
}
